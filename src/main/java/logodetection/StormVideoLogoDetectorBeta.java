 ...
 * {@link #addTemplate(tools.Serializable.PatchIdentifier, tools.Serializable.Mat)}.
 * <p>
 * 5. Also you may want to increment the priority of the existing logo template. Then you call
 * {@link #incrementPriority(tools.Serializable.PatchIdentifier, int)}.
 *
 * @see LogoTemplate
 * @see RobustMatcher
 * *
...
//            }
     ...
     * @see logodetection.LogoTemplate#toString()
     */
